			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search">
					...
					<%
						...
						if(khachHang==null){
					%>
						<a class="btn btn-primary" style="white-space: nowrap;" href="<%= url %>/khachhang/login.jsp">
							Đăng nhập
						</a>
					<%} else { %>
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
						<li class="nav-item dropdown dropstart"><a
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="<%=url %>/khachhang/changeImage.jsp">Thay đổi ảnh avatar</a></li>
								<li><a class="dropdown-item" href="<%=url %>/do-action?hanhDong=logout">Thoát tài khoản</a></li>
							</ul>
						</li>
					</ul>				
